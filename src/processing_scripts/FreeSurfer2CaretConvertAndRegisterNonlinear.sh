...
for Hemisphere in L R ; do
  ...
  # I CHANGED THIS SCRIPT TO EVANS FIX- MARIO
...
###  Insert the LGI conversion into here !! - MArio
...
#Remove fsaverage folder as it is no longer needed.   thickness.native.shape.gii
