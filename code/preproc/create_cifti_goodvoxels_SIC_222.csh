...
set subj = $1
set basedir = /data/nil-bluearc/GMT/Dillan/preproc_2018-07-03/$subj
set workbenchdir = /data/heisenberg/data1/mario/TIM_CN4/workbench/bin_linux64
set maskdir = $basedir/subcortical_mask_222/
set surfdir = $basedir/7112b_fs_LR/
set volume_mask = $maskdir/subcortical_mask_LR_222.nii
set vol_smooth = 0
...
set cifti_name = ${timename}_LR_surf_subcort_222_32k_fsLR_surfsmooth${surf_smooth}_volsmooth${vol_smooth}.dtseries.nii
...
wb_command -cifti-create-dense-timeseries ${cifti_name} -volume ${timename}.nii.gz $volume_mask -left-metric $L_surface -roi-left $L_mask -right-metric $R_surface -roi-right $R_mask -timestep $TR -timestart 0
