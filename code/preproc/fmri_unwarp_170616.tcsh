...
#$Header: /data/petsun4/data1/solaris/csh_scripts/RCS/fmri_unwarp_170616.tcsh,v 1.2 2020/05/17 01:24:08 avi Exp $
#$Log: fmri_unwarp_170616.tcsh,v $
# Revision 1.2  2020/05/17  01:24:08  avi
# correct misleading dwell info
#
# Revision 1.1  2017/07/08  04:27:53  avi
# Initial revision
#
set idstr = '$Id: fmri_unwarp_170616.tcsh,v 1.2 2020/05/17 01:24:08 avi Exp $'
echo $idstr
set program = $0:t
...
echo "N.B.:	<dwell> is <epi> 1000/PixelBandwith (value should be in range .4 - .6)"
