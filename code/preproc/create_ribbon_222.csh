...
foreach hem ( L R )
  ...
  set T1image = ${basedir}/T1/${subject}_mpr_debias_avgT_222_t88.nii.gz
  niftigz_4dfp -n $T1image:r:r $T1image:r:r
  set nativedir = $basedir/7112b_fs_LR/Native/
  set outputdir = $basedir/7112b_fs_LR/Ribbon_222/
  echo "${outputdir}"
  mkdir "${outputdir}"
  ...
  fslmaths ${outputdir}/${subject}.${hem}.pial_uthr0.native.nii.gz -mas ${outputdir}/${subject}.${hem}.white_thr0.native.nii.gz -mul 255 ${outputdir}/${subject}.${hem}.ribbon_222.nii.gz
  fslmaths ${outputdir}/${subject}.${hem}.ribbon_222.nii.gz -bin -mul $GreyRibbonValue ${outputdir}/${subject}.${hem}.ribbon_222.nii.gz
...
fslmaths ${outputdir}/${subject}.L.ribbon_222.nii.gz -add ${outputdir}/${subject}.R.ribbon_222.nii.gz ${outputdir}/ribbon_222.nii.gz
#rm ${outputdir}/${subject}.L.ribbon.nii.gz ${outputdir}/${subject}.R.ribbon.nii.gz
${CARET7DIR}/wb_command -volume-label-import ${outputdir}/ribbon_222.nii.gz ${freelabels} ${outputdir}/ribbon_222.nii.gz -discard-others -unlabeled-value 0
